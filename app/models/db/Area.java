...
public class Area extends Model {
	...
	public static Area create(String zid, String name, String tags,
			User createdBy) {
		Area zone = new Area();
		zone.zid = zid;
		zone.name = name;
	...
	public static Area findByTags(String tag) {
	...
	public static List<Area> search(String keyword, int page, int length) {
	...
	private static JPAQuery query(String select, String keyword) {
		StringBuilder sql = new StringBuilder();
		sql.append(" FROM Area c WHERE status = :status ");
