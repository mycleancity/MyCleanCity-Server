Raphael.fn.pieChart = function (cx, cy, r, values, stroke) {
    ...
    var angle = 90,
        ...
        process = function (j) {
            ...
            if(values[j] == 100) {
                var p = paper.circle(cx, cy, r).attr({fill: "#75D2FB", stroke: "#ea503d", "stroke-width": 0});
            }else{
                if (j == 1) {
                    var p = sector(cx, cy, r, angle, angle + angleplus, {fill: "90-#75D2FB-#75D2FB", stroke: stroke, "stroke-width": 0});
                }else{
